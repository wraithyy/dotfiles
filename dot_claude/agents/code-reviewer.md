---
name: code-reviewer
description: Expert code review specialist for quality, security, and maintainability. Use after significant changes — multi-file features, auth/security/payment code, breaking API changes, migrations — or when the user asks for review. Default Sonnet. Downgrade to Haiku when: PR <200 lines, no auth/security/payment touches, no breaking API changes, no migration.
